...
ENDPOINT_JOB_TYPES: dict[str, frozenset[str]] = {
    ...
    "/pipelines/filter-long-reads": frozenset({"filter_long_reads"}),
    "/pipelines/feature-coverage": frozenset({"feature_coverage"}),
    "/pipelines/variants-in-regions": frozenset({"variants_in_regions"}),
    "/pipelines/annotation-comparison": frozenset({"annotation_comparison"}),
    "/pipelines/extract-sequences": frozenset({"sequence_extraction"}),
    ...
    "/pipelines/merge-transcripts": frozenset({"merge_transcripts"}),
    ...
    "/pipelines/binning": frozenset({"binning"}),
    "/pipelines/bin-qc": frozenset({"score_bin_quality"}),
