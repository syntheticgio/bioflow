...
mod tests {
    ...
    #[test]
    fn storage_and_exposure_round_trip_through_render_env() {
        // Same convention guard as round_trips_through_render_env: the
        // parsers here and render_env's write format must not drift apart,
        // or a relaunch would misread what Apply itself wrote.
        let settings = crate::settings::CurrentSettings {
            storage_location: std::path::PathBuf::from("/data"),
            port: 5173,
