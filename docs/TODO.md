...
possibly still being present and wanted.

Confirmed *is* user-visible while a blob sits in this state:
...
available... check that the drive is mounted" -- a false message for content
