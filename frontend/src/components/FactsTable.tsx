...
export const LABELS: Record<string, string> = {
  ...
  checkm2_quality_score: "Quality score",
  checkm2_quality_tier: "Quality tier",
  checkm2_completeness_model: "Completeness model",
  checkm2_coding_density: "Coding density",
  checkm2_contig_n50: "Contig N50",
  checkm2_genome_size: "Genome size",
  checkm2_gc_content: "GC content",
  checkm2_total_contigs: "Contigs",
  checkm2_notes: "CheckM2 notes",
  checkm2_version: "CheckM2 version",
  checkm2_scored_bins: "Bins scored",
  checkm2_db_key: "CheckM2 database",
...
const GROUPS: FactGroup[] = [
  ...
  {
    title: "Bin quality",
    note: "Estimated by CheckM2. Contamination above 100% is real: it means several organisms merged into one bin.",
    keys: [
