...
export function AnnotationResults({ obj }: { obj: ObjectDetailData }) {
  ...
  return (
    <OnDemandCompute
      objectId={obj.id}
      jobType="run_annotation_stats"
      launch={useCallback(
        () => api.launchAnnotationStats(obj.id, targetNode || undefined),
        [obj.id, targetNode],
      )}
      hasResults={f.annotation_stats_status === "ok"}
              ...
              <>
                ...
                <div className="section">
                  ...
                  {f.annotation_contig_lengths_known === false ? (
                    ...
                    // reference, and none was resolved for this annotation.
                    <div className="section-note">
                      Coverage needs the sequence lengths from this
                      annotation's reference, and no matching reference was
                      found in this project. Add the reference genome and the
                      coverage will be computed automatically.
                    </div>
                  ) : (
                    <>
                      <div className="section-note">
                        Fraction of each sequence covered by at least one
                        feature. Overlapping features are counted once.
                      </div>
